# Checkmarx CxFlow JavaScript Github Action <img src="images/github.png" alt="Github" width="40" height="40">
...
![Checkmarx](images/Checkmarx Logo - RGB Blue.png)
...
|-------------------------|------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|----------|--------------------------------|
| java_path | C:\Program Files\Eclipse Adoptium\jdk-17.0.7.7-hotspot\bin\java | String | Yes | N/A |
| cxflow_jar_path | C:\CxFlow\cx-flow.jar | Location of CxFlow jar file on self-hosted runner | String | No | C:\CxFlow\cx-flow.jar |
